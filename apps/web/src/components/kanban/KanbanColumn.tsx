...
export function KanbanColumn({
  ...
  return (
    ...
    >
      <header className="border-b border-slate-200/80 px-3 py-2">
        <h2
        ...
        <p className="text-xs text-slate-500">{applications.length} cards</p>
      </header>
      <ul
        ref={setNodeRef}
      ...
      >
        {applications.length === 0 ? (
          <li className="rounded-md border border-dashed border-slate-300/90 px-2 py-8 text-center text-xs text-slate-500">
